...
namespace SdetBootcampDay3.Exercises
{
    ...
    public class Exercises01
    {
        ...
        public async Task GetDataForUser3_CheckServerHeader_ShouldBeCloudflare()
        {
            ...
            //  Elegant solution from Tom
            //Assert.That(response.GetHeaderValue("Server"), Is.EqualTo("cloudflare"));

            //  Even more elegant solution from Mark
        ...
        public async Task GetDataForUser5_CheckCompanyName_ShouldBeKeeblerLLC()
        {
            ...
            // Simple but imperfect version. Gets the job done. 
            //Assert.That(responseData.SelectToken("company")!.ToString(), Does.Contain("Keebler LLC"));

            // string foo = "bar";
            // Assert.That(foo).ToString(), Is.EqualTo("Keebler LLC");
